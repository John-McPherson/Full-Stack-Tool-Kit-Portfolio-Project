...
urlpatterns = [
    ...
    path(
        "update_modifiers", views.ModifierList.as_view(), name="modifier_list"
    ),
    path(
        "confirm_recipe", views.ConfirmRecipe.as_view(), name="confirm_recipe"
    ),
    path(
        "display_recipe", views.DisplayRecipe.as_view(), name="display_recipe"
    ),

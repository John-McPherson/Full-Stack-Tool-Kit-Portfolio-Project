    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient_type', models.IntegerField(choices=[(0, 'Base'), (1, 'Modifier')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='UserData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drink_type', models.IntegerField(choices=[(0, 'Up'), (1, 'On The Rocks'), (2, 'Long')], default=0)),
                ('recipe_steps', models.TextField()),
                ('ingredients_list', models.TextField()),
                ('modifiers', models.TextField()),
                ('ingredients', models.TextField()),
                ('approved', models.IntegerField(choices=[(0, 'Awaiting Approval'), (1, 'Approved')], default=0)),
